    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="text-[12px]" style={{ color: '#7a5ea0', fontFamily: 'Georgia, serif' }}>
          {reviewQueue.length} pending reviews · {worksheets.length} templates
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-white rounded-[14px] p-5"
          ...
          <div className="text-[14px] font-bold mb-4" style={{ fontFamily: 'Georgia, serif', color: '#2d1a47' }}>📝 Worksheet Templates</div>
          {worksheets.map(w => (
        ...
        <div className="bg-white rounded-[14px] p-5"
          style={{ border: '1px solid rgba(98,52,145,0.1)', boxShadow: '0 2px 16px rgba(98,52,145,0.06)' }}>
          <div className="text-[14px] font-bold mb-4" style={{ fontFamily: 'Georgia, serif', color: '#2d1a47' }}>📋 Coach Review Queue</div>
          {reviewQueue.map(r => (
            <div key={r.id} className="flex items-center justify-between py-3 cursor-pointer hover:bg-[rgba(232,196,135,0.08)] rounded-lg px-2"
              ...
              <button className="flex items-center gap-1 px-3 py-[6px] rounded-full text-[10.5px] font-bold cursor-pointer"
