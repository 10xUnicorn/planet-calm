...
const offers = [
  { icon: '🐾', name: 'Peaceful Paws Collective', price: '$49/mo', desc: 'Community access, content library, Heartbeat space, monthly group calls', tier: 'collective' },
  { icon: '🌿', name: 'Peaceful Progress Studio', price: '$275/mo', desc: 'Everything in Collective plus worksheets, coach messaging, progress tracking', tier: 'studio' },
  { icon: '✦', name: 'Calm Council', price: '$6K/yr', desc: 'VIP access, 1:1 coaching, exclusive content, deal perks, partner resources', tier: 'council' },
  { icon: '🗺️', name: 'Wayfinder Experience', price: '$25K', desc: 'Immersive 2-day experience with Stephanie. Pre-event prep, post-event resources', tier: 'wayfinder' },
  { icon: '📖', name: '"What the BARK?" Book', price: '$20', desc: 'Pre-order Stephanie\'s debut book on Calm-First Leadership. Ships Sept 2026', tier: 'book' },
  { icon: '🦴', name: 'Completely Calm Chew Sub', price: '$42/mo', desc: 'Monthly calming chew subscription. Science-backed formulas for your dog', tier: 'chew' },
]
  ...
  return (
    <div>
      ...
      <div className="rounded-[16px] p-6 mb-6"
        ...
        <h3 className="text-[18px] font-bold mb-1" style={{ fontFamily: 'Georgia, serif', color: '#2d1a47' }}>
          Welcome Home, Stephanie ✦
        </h3>
        <p className="text-[12.5px] italic" style={{ color: '#7a5ea0', fontFamily: 'Georgia, serif' }}>
          &quot;Calm is not the absence of challenge — it is the mastery of response.&quot;
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-[14px] p-5"
          ...
          <div className="text-[10px] font-bold" style={{ color: '#623491' }}>68% — Learning Path</div>
        </div>
        <div className="bg-white rounded-[14px] p-5"
          style={{ border: '1px solid rgba(98,52,145,0.1)', boxShadow: '0 2px 16px rgba(98,52,145,0.06)' }}>
          ...
          <div className="text-[12.5px] font-bold" style={{ fontFamily: 'Georgia, serif', color: '#2d1a47' }}>
            Complete Worksheet 3 — Calm Anchoring
          </div>
        </div>
        <div className="bg-white rounded-[14px] p-5"
          style={{ border: '1px solid rgba(98,52,145,0.1)', boxShadow: '0 2px 16px rgba(98,52,145,0.06)' }}>
      ...
      <div className="grid grid-cols-3 gap-[14px] mb-6">
        {offers.map(o => (
          <div key={o.tier} className="bg-white rounded-[13px] p-[18px]"
            ...
            <div className="text-[22px] mb-2">{o.icon}</div>
            ...
            <button className="w-full py-2 rounded-lg text-[11.5px] font-bold cursor-pointer transition-opacity hover:opacity-85"
              style={{
      ...
      <div className="bg-white rounded-[14px] p-5"
        style={{ border: '1px solid rgba(98,52,145,0.1)', boxShadow: '0 2px 16px rgba(98,52,145,0.06)' }}>
        <div className="text-[14px] font-bold mb-4" style={{ fontFamily: 'Georgia, serif', color: '#2d1a47' }}>🔗 Quick Links</div>
        <div className="grid grid-cols-4 gap-3">
          {[
            { label: 'My Worksheets', href: '/worksheets', icon: '📝' },
            { label: 'Content Library', href: '/content', icon: '📚' },
            { label: 'Community', href: '/community', icon: '🐾' },
            { label: 'Messages', href: '/messaging', icon: '💬' },
          ].map(l => (
