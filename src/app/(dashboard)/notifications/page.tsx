  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="flex items-center gap-1 text-[11px] cursor-pointer px-3 py-[6px] rounded-full"
      ...
      <div className="bg-white rounded-[14px] overflow-hidden"
        ...
        {demoNotifications.map(n => (
          <div key={n.id} className="flex items-start gap-3 px-5 py-4 cursor-pointer transition-all hover:bg-[rgba(232,196,135,0.08)]"
            style={{
